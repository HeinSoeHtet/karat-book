...
export default function NewItemPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const loadingToast = toast.loading(tInventoryAdd('saving'));
        ...
        try {
            ...
            if (!dbResult.success) {
                throw new Error(dbResult.error || tInventoryAdd('failAdd'));
            }

            toast.success(tInventoryAdd('addedSuccess'), { id: loadingToast });
            router.push('/inventory');
        } catch (error) {
            console.error('Error adding item:', error);
            const errorMessage = error instanceof Error ? error.message : tInventoryAdd('failAdd');
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6 sm:mb-10">
                ...
                <p className="text-amber-200/60 text-xs sm:text-lg">{tInventoryAdd('description')}</p>
            </div>
