...
export default function NewItemPage() {
    ...
    const t = useTranslations('inventory_add');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!dbResult.success) {
                throw new Error(dbResult.error || t('failAdd'));
            }

            toast.success(t('addedSuccess'), { id: loadingToast });
            router.push('/inventory');
        } catch (error) {
            console.error('Error adding item:', error);
            const errorMessage = error instanceof Error ? error.message : t('failAdd');
